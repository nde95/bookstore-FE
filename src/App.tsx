...
import { AccessDenied, Home, Login, MyOrders, NotFound, OrderConfirmed, OrderDetailsPage, Payment, ProductDetails, Register, ShoppingCart } from './Pages';
    ...
    <Header />
      <div className='pb-5'>
        <Routes>
          ...
          <Route path='/order/orderDetails/:id' element={<OrderDetailsPage />}></Route>
